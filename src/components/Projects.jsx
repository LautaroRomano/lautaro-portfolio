                    ...
                    <Flex w={'100%'} flexDir={'column'}>
                        ...
                        <Flex position={'relative'} w={'100%'} flexDir={'column'} gap={5}>
                            ...
                            <Flex w={'100%'} justify={'space-between'} mt={5} flexDir={['column', 'column', 'row', 'row']}>
                                ...
                                >
                                    <Image src='/img/bronovios.png' objectFit={'contain'} position={'absolute'} top={10} left={10} onClick={() => { onOpen(); setImgRef('/img/bronovios.png') }} />
                                </Flex>
                            ...
                            <Flex w={'100%'} justify={'space-between'} mt={5} flexDir={['column', 'column', 'row', 'row']}>
                                ...
                                <Flex w={['100%', '100%', '55%', '55%']} flexDir={'column'} ps={[0, 0, 25, 25]} justifyContent={'space-between'} gap={[5, 5, 2, 2]} mt={['15px', '15px', '0px', '0px']}>
                                    <Text color={'#fff'} fontSize={['x-large', 'x-large', 'xx-large', 'xx-large']} fontWeight={'bold'}>Nutriblock Web</Text>
                                    <Flex w={'100%'} gap={2} flexWrap={'wrap'}>
                                        <Flex bg={technologies.next.bg} padding={'1px 10px'} align={'center'} gap={'10px'} color={technologies.next.color} borderRadius={'2xl'}>
                                            <technologies.next.icon />
                                            <Text>
                            ...
                            <Flex w={'100%'} justify={'space-between'} mt={5} flexDir={['column', 'column', 'row', 'row']}>
                                ...
                                <Flex w={['100%', '100%', '55%', '55%']} flexDir={'column'} ps={[0, 0, 25, 25]} justifyContent={'space-between'} gap={[5, 5, 2, 2]} mt={['15px', '15px', '0px', '0px']}>
                                    <Text color={'#fff'} fontSize={['x-large', 'x-large', 'xx-large', 'xx-large']} fontWeight={'bold'}>Nutriblock Mobile</Text>
                                    <Flex w={'100%'} gap={2} flexWrap={'wrap'}>
                                    ...
                                    <Text color={'#ccc'} fontWeight={'semibold'} >
                                        Aplicacion mobile para ayudar a los pacientes a tener un contacto directo con sus nutricionistas, pudiendo ver sus citas, sus alimentos para cada dia y mas...
                                    </Text>
                                    <Flex >
                                        <Link href='#' >
                                            <MyButton><FaLink /> Preview</MyButton>
